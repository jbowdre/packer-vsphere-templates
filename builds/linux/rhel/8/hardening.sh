#!/bin/bash -eu
# Performs steps to harden RHEL8 toward the CIS Level 2 benchmark
...
current_task "$rule_name"
password_pam_faillock_deny='3'
password_pam_faillock_time='900'
sudo authselect enable-feature with-faillock
sudo authselect apply-changes -b
FAILLOCK_CONF="/etc/security/faillock.conf"
regex_deny="^\s*deny\s*="
regex_time="^\s*unlock_time\s*="
line_deny="deny = $password_pam_faillock_deny"
line_time="unlock_time = $password_pam_faillock_time"
...
current_task "$rule_name"
sudo sed -i '/^[[:space:]]*#[[:space:]]*auth[[:space:]]\+required[[:space:]]\+pam_wheel\.so[[:space:]]\+use_uid$/s/^[[:space:]]*#//' /etc/pam.d/su
...
sysctl_params=(
  "CCE-81005-9,Configure Accepting Routing Advertisements on All IPv6 Interfaces,net.ipv6.conf.all.accept_ra,0"
  "CCE-81009-3,Disable Accepting ICMP Redirects for All IPv6 Interfaces,net.ipv6.conf.all.accept_redirects,0"
  "CCE-81013-5,Disable Kernel Parameter for Accepting Source-Routed Packets on all IPv6 Interfaces,net.ipv6.conf.all.accept_source_route,0"
  "CCE-82863-2,Disable Kernel Parameter for IPv6 Forwarding,net.ipv6.conf.all.forwarding,0"
  "CCE-81007-7,Disable Accepting Router Advertisements on all IPv6 Interfaces by Default,net.ipv6.conf.default.accept_ra,0"
  "CCE-81010-1,Disable Kernel Parameter for Accepting ICMP Redirects by Default on IPv6 Interfaces,net.ipv6.conf.default.accept_redirects,0"
  "CCE-81015-0,Disable Kernel Parameter for Accepting Source-Routed Packets on IPv6 Interfaces by Default,net.ipv6.conf.default.accept_source_route,0"
  "CCE-80917-8,Disable Accepting ICMP Redirects for All IPv4 Interfaces,net.ipv4.conf.all.accept_redirects,0"
  "CCE-81011-9,Disable Kernel Parameter for Accepting Source-Routed Packets on all IPv4 Interfaces,net.ipv4.conf.all.accept_source_route,0"
  "CCE-81018-4,Enable Kernel Parameter to Log Martian Packets on all IPv4 Interfaces,net.ipv4.conf.all.log_martians,1"
  "CCE-81021-8,Enable Kernel Parameter to Use Reverse Path Filtering on all IPv4 Interfaces,net.ipv4.conf.all.rp_filter,1"
  "CCE-81016-8,Disable Kernel Parameter for Accepting Secure ICMP Redirects on all IPv4 Interfaces,net.ipv4.conf.all.secure_redirects,0"
  "CCE-80919-4,Disable Kernel Parameter for Accepting ICMP Redirects by Default on IPv4 Interfaces,net.ipv4.conf.default.accept_redirects,0"
  "CCE-80920-2,Disable Kernel Parameter for Accepting Source-Routed Packets on IPv4 Interfaces by Default,net.ipv4.conf.default.accept_source_route,0"
  "CCE-81020-0,Enable Kernel Paremeter to Log Martian Packets on all IPv4 Interfaces by Default,net.ipv4.conf.default.log_martians,1"
  "CCE-81022-6,Enable Kernel Parameter to Use Reverse Path Filtering on all IPv4 Interfaces by Default,net.ipv4.conf.default.rp_filter,1"
  "CCE-81017-6,Configure Kernel Parameter for Accepting Secure Redirects By Default,net.ipv4.conf.default.secure_redirects,0"
  "CCE-80922-8,Enable Kernel Parameter to Ignore ICMP Broadcast Echo Requests on IPv4 Interfaces,net.ipv4.icmp_echo_ignore_broadcasts,1"
  "CCE-81023-4,Enable Kernel Parameter to Ignore Bogus ICMP Error Responses on IPv4 Interfaces,net.ipv4.icmp_ignore_bogus_error_responses,1"
  "CCE-80923-6,Enable Kernel Parameter to Use TCP Syncookies on Network Interfaces,net.ipv4.tcp_syncookies,1"
  "CCE-80918-6,Disable Kernel Parameter for Sending ICMP Redirects on all IPv4 Interfaces,net.ipv4.conf.all.send_redirects,0"
  "CCE-80921-0,Disable Kernel Parameter for Sending ICMP Redirects on all IPv4 Interfaces by Default,net.ipv4.conf.default.send_redirects,0"
  "CCE-81024-2,Disable Kernel Parameter for IP Forwarding on IPv4 Interfaces,net.ipv4.ip_forward,0"
  "CCE-80916-0,Enable Randomized Layout of Virtual Address Space,kernel.randomize_va_space,2"
)
...
rule_name="Disable modules: DCCP, SCTP, cramfs, squashfs, udf, usb-storage"
current_task "$rule_name"
modules=(
  "cramfs"
  "dccp"
