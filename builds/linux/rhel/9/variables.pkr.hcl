/*
    DESCRIPTION:
    Rocky Linux 9 variables using the Packer Builder for VMware vSphere (vsphere-iso).
*/
...
variable "rhsm_username" {
  type        = string
  description = "The username used to register with RHSM."
  sensitive   = true
}

variable "rhsm_password" {
  type        = string
  description = "The password used to register with RHSM."
  sensitive   = true
}

variable "rhsm_pool" {
  type        = string
  description = "The RHSM pool ID for attaching a subscription. If not set, assumes '--auto-attach'."
  sensitive   = true
  default     = ""
}
