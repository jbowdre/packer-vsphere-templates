#!/bin/bash -eu
# Performs steps to harden CentOS 7 toward the CIS Level 2 benchmark
...
for pam_file in "${pam_files[@]}"; do
  LAST_MATCH_LINE=$(grep -nP "^password.*requisite.*pam_pwquality\.so" "$pam_file" | tail -n 1 | cut -d: -f 1)
  sudo sed -i --follow-symlinks "$LAST_MATCH_LINE"' a password    '"$password_pam_remember_control_flag"'     pam_pwhistory.so remember='"$password_pam_remember" "$pam_file"
done
...
rule_name="Ensure the Default Bash Umask is Set Correctly | Ensure the Default Umask is Set Correctly in /etc/profile"
current_task "$rule_name"
...
rule_name="Ensure auditd Collects Information on the Use of Privileged Commands: insmod, modprobe, rmmod"
current_task "$rule_name"
audit_key="modules_load"
audit_rule_file="/etc/audit/rules.d/${audit_key}.rules"
sudo touch "${audit_rule_file}"
sudo chmod 0640 "${audit_rule_file}"
audit_list=(
...
rule_name="Verify /boot/grub2/grub.cfg Permissions"
current_task "$rule_name"
...
sysctl_params=(
  "CCE-80180-3,Configure Accepting Routing Advertisements on All IPv6 Interfaces,net.ipv6.conf.all.accept_ra,0"
  "CCE-80182-9,Disable Accepting ICMP Redirects for All IPv6 Interfaces,net.ipv6.conf.all.accept_redirects,0"
  "CCE-80179-5,Disable Kernel Parameter for Accepting Source-Routed Packets on all IPv6 Interfaces,net.ipv6.conf.all.accept_source_route,0"
  "CCE-80356-9,Disable Kernel Parameter for IPv6 Forwarding,net.ipv6.conf.all.forwarding,0"
  "CCE-80181-1,Disable Accepting Router Advertisements on all IPv6 Interfaces by Default,net.ipv6.conf.default.accept_ra,0"
  "CCE-80183-7,Disable Kernel Parameter for Accepting ICMP Redirects by Default on IPv6 Interfaces,net.ipv6.conf.default.accept_redirects,0"
  "CCE-80355-1,Disable Kernel Parameter for Accepting Source-Routed Packets on IPv6 Interfaces by Default,net.ipv6.conf.default.accept_source_route,0"
  "CCE-80158-9,Disable Accepting ICMP Redirects for All IPv4 Interfaces,net.ipv4.conf.all.accept_redirects,0"
  "CCE-27434-0,Disable Kernel Parameter for Accepting Source-Routed Packets on all IPv4 Interfaces,net.ipv4.conf.all.accept_source_route,0"
  "CCE-80160-5,Enable Kernel Parameter to Log Martian Packets on all IPv4 Interfaces,net.ipv4.conf.all.log_martians,1"
  "CCE-80167-0,Enable Kernel Parameter to Use Reverse Path Filtering on all IPv4 Interfaces,net.ipv4.conf.all.rp_filter,1"
  "CCE-80159-7,Disable Kernel Parameter for Accepting Secure ICMP Redirects on all IPv4 Interfaces,net.ipv4.conf.all.secure_redirects,0"
  "CCE-80163-9,Disable Kernel Parameter for Accepting ICMP Redirects by Default on IPv4 Interfaces,net.ipv4.conf.default.accept_redirects,0"
  "CCE-80162-1,Disable Kernel Parameter for Accepting Source-Routed Packets on IPv4 Interfaces by Default,net.ipv4.conf.default.accept_source_route,0"
  "CCE-80161-3,Enable Kernel Paremeter to Log Martian Packets on all IPv4 Interfaces by Default,net.ipv4.conf.default.log_martians,1"
  "CCE-80168-8,Enable Kernel Parameter to Use Reverse Path Filtering on all IPv4 Interfaces by Default,net.ipv4.conf.default.rp_filter,1"
  "CCE-80164-7,Configure Kernel Parameter for Accepting Secure Redirects By Default,net.ipv4.conf.default.secure_redirects,0"
  "CCE-80165-4,Enable Kernel Parameter to Ignore ICMP Broadcast Echo Requests on IPv4 Interfaces,net.ipv4.icmp_echo_ignore_broadcasts,1"
  "CCE-80166-2,Enable Kernel Parameter to Ignore Bogus ICMP Error Responses on IPv4 Interfaces,net.ipv4.icmp_ignore_bogus_error_responses,1"
  "CCE-27495-1,Enable Kernel Parameter to Use TCP Syncookies on Network Interfaces,net.ipv4.tcp_syncookies,1"
  "CCE-80156-3,Disable Kernel Parameter for Sending ICMP Redirects on all IPv4 Interfaces,net.ipv4.conf.all.send_redirects,0"
  "CCE-80999-6,Disable Kernel Parameter for Sending ICMP Redirects on all IPv4 Interfaces by Default,net.ipv4.conf.default.send_redirects,0"
  "CCE-80157-1,Disable Kernel Parameter for IP Forwarding on IPv4 Interfaces,net.ipv4.ip_forward,0"
  "CCE-26900-1,Disable Core Dumps for SUID programs,fs.suid_dumpable,0"
  "CCE-27127-0,Enable Randomized Layout of Virtual Address Space,kernel.randomize_va_space,2"
)
...
rule_name="Disable modules: Bluetooth, DCCP, SCTP, cramfs, squashfs, udf, usb-storage"
current_task "$rule_name"
modules=(
  "bnep"
  "bluetooth"
...
current_task "$rule_name"
sudo echo "*     hard   core    0" | sudo tee -a /etc/security/limits.conf
...
rule_name="Configure SSHD: ClientAliveCountMax, ClientAliveInterval, HostbasedAuthentication, PermitEmptyPasswords, IgnoreRhosts, AllowTcpForwarding, X11Forwarding, PermitUserEnvironment, LoginGraceTime, LogLevel, MaxAuthTries, MaxSessions, MaxStartups, Ciphers, MACs"
current_task "$rule_name"
sshd_options=(
