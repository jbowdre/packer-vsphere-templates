...
variable "tdnf_packages" {
  type          = list(string)
  description   = "A list of tdnf packages to install during the kickstart installer."
  default       = []
}

variable "tdnf_mirror" {
  type          = string
  description   = "Sets the default tdnf mirror during the kickstart installer."
  default       = ""
}
