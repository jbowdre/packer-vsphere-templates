...
variable "vm_inst_os_kms_key" {
  type        = string
  description = "The installation operating system KMS key input for Microsoft Windows."
  default     = "N69G4-B89J2-4G8F4-WWYCC-J464C"
}

variable "vm_inst_os_org" {
  type        = string
  description = "Organization to which the VM belongs. This is probably your company name."
  default     = ""
}

variable "vm_inst_os_support_phone" {
  type        = string
  description = "Organization's support phone number."
  default     = ""
}

variable "vm_inst_os_support_url" {
  type        = string
  description = "Organization's support website."
  default     = ""
}
